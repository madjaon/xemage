...
<div class="row margin-bottom">
	<div class="col-xs-12">
		<a href="{{ route('admin.posttag.create') }}" class="btn btn-primary">Thêm post tags</a>
	</div>
</div>
			...
			<div class="box-body table-responsive no-padding">
				<table class="table table-hover">
					...
					<tr>
						...
						<td>
							<a href="{{ CommonUrl::getUrlPostTag($value->slug) }}" class="btn btn-success" target="_blank">Xem</a>
							<a href="{{ route('admin.posttag.edit', $value->id) }}" class="btn btn-primary">Sửa</a>
