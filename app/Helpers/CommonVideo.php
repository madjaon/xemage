...
class CommonVideo
{
    ...
    */
    ...
    /*
    * GOOGLE DRIVE
    * link type: https://drive.google.com/file/d/0B77yw2zOQcK_MGhYWHB3aENISlk/view?usp=sharing
    *
    */
    static function getLinkGoogleDrive($link)
    {
        $link = trim($link);
        if(preg_match('/.*drive.google.com\/.*\/(.*?)\/.*/is', $link, $id)){
            $result['success'] = 'https://googledrive.com/host/'.$id[1];
        }else{
